...
const Footer = () => {
    return (
        <footer className='container-fluid footer-bg-color text-white pt-3 ps-1'>         
            <div className="container"> 
                <div className="row">
                    <div className="col-12 col-md-4 d-flex flex-column mt-2 pb-3">
                        <h5>Categorias</h5>
                    ...
                    <div className="col-12 col-md-4 mt-2 pb-3">
                        <h5>Contactanos</h5>
